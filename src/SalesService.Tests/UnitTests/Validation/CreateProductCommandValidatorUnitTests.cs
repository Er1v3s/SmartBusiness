...
namespace SalesService.Tests.UnitTests.Validation
{
    public class CreateProductCommandValidatorUnitTests
    {
        ...
        {
            yield return [new string('a', 101)]; // max 50 characters
        }
        ...
        {
            // Arrange
            var command = new CreateProductCommand(invalidProductName, "testDescription", new List<string> { "testCategory" }, 99.99m, 5, "testImageFile");
        ...
        {
            // Arrange
            var command = new CreateProductCommand(validProductName, "testDescription", new List<string> { "testCategory" }, 99.99m, 5, "testImageFile");
        ...
        {
            // Arrange
            var command = new CreateProductCommand("TestProductName", invalidProductDescription, new List<string> { "testCategory" }, 99.99m, 5, "testImageFile");
        ...
        {
            // Arrange
            var command = new CreateProductCommand("TestProductName", validProductDescription, new List<string> { "testCategory" }, 99.99m, 5, "testImageFile");
        ...
        {
            // Arrange
            var command = new CreateProductCommand("TestProductName", "TestProductDescription", new List<string> { invalidProductCategory }, 99.99m, 5, "testImageFile");
        ...
        {
            // Arrange
            var command = new CreateProductCommand("TestProductName", "TestProductDescription", new List<string> { validProductCategory }, 99.99m, 5, "testImageFile");
