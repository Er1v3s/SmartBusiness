...
export const UserPage: React.FC = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-var(--spacing)*16)] bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-900 dark:to-gray-800">
      {/* Sidebar */}
      <aside className="w-64 flex-col gap-2 border-r border-gray-200 bg-white/80 px-4 py-10 text-gray-800 shadow-lg dark:border-gray-800 dark:bg-gray-900/80 dark:text-gray-100 dark:shadow-black/30">
        ...
        {menu.map((item) => (
          <button
            ...
            className={`flex items-center gap-3 rounded-lg px-4 py-3 text-lg font-medium transition-all hover:bg-cyan-100/70 dark:hover:bg-indigo-900/40 ${
              view === item.label
      ...
      {/* Main content */}
      <main className="flex flex-1 items-start justify-center bg-transparent px-4 py-12 text-gray-900 dark:text-gray-100">
