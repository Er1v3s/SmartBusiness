      ...
      <aside className="w-64 flex-col gap-2 border-r border-gray-200 bg-white/80 px-4 py-10 text-gray-800 shadow-lg dark:border-gray-950 dark:bg-gray-900 dark:text-gray-100 dark:shadow-black/30">
        ...
        {menu.map((item) => (
          <button
            ...
            className={`flex w-full min-w-[180px] items-center gap-3 rounded-lg px-4 py-3 text-lg font-medium transition-colors duration-150 hover:bg-indigo-50 hover:text-indigo-700 dark:hover:bg-indigo-900 dark:hover:text-indigo-200 ${
              view === item.label
