...
// Home Page Component
export const HomePage: React.FC<{ onNavigate: (page: Page) => void }> = ({
  onNavigate,
}) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
      {/* Hero Section */}
      <div className="relative z-10 mx-auto max-w-4xl px-6 pt-20 pb-32 text-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-80 w-80 animate-pulse rounded-full bg-purple-500 opacity-70 mix-blend-multiply blur-xl filter"></div>
        <div className="absolute -bottom-40 -left-40 h-80 w-80 animate-pulse rounded-full bg-cyan-500 opacity-70 mix-blend-multiply blur-xl filter"></div>
      </div>
    </div>
  );
};
