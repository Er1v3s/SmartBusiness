...
export const ProductsSection = () => {
  ...
  // Modal komponent do edycji produktu
  ...
  return (
    <div className="h-full w-full p-4">
      ...
      {/* Paginacja */}
      {/* Kompaktowa paginacja: tylko strzałki i numeracja bieżącej strony */}
      <div className="relative mt-4 flex min-w-[180px] flex-wrap items-center justify-center gap-4">
        ...
        {/* Ilość na stronę w prawym dolnym rogu */}
